"""
Django settings for prj_dir project.
...
SECRET_KEY = 'django-insecure-&8i%^(s^$#%6@2#bn7oy_3r8=k_l#gu0g_#!z0z1-mwe!&0#tl'
...
WSGI_APPLICATION = 'prj_dir.wsgi.application'
